...
const CompanyListTab = ({
  ...
  const { mutate: deleteList } = useDeleteLeadList(LeadType.LEAD_COMPANY);
  ...
  const handleView = useCallback(
    (id: string) => {
      router.push(appRoutes.leadgen.leadList.company(id));
    },
    [router]
  );
  ...
  return (
    <div className="flex-1 overflow-auto p-6">
      <DataTable
        ...
        defaultMessage="No company lists found. Create a list to get started."
